...
pub struct Env {
    ...
    pub wss_url: String,
    pub inf_https_url: String,
    pub inf_wss_url: String,
    pub chain_id: U64,
...
impl Env {
    pub fn new() -> Self {
        Env {
            ...
            inf_https_url: get_env("INF_HTTPS_URL"),
            inf_wss_url: get_env("INF_WSS_URL"),
...
pub fn get_blacklist_tokens() -> Vec<H160> {
    vec![
        "0x9469603F3Efbcf17e4A5868d81C701BDbD222555",
